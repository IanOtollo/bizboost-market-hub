...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Experience premium online shopping with IOMBiz. Quality products, formal service, and reliable delivery across Kenya." },
      { name: "author", content: "IOMBiz Corporation" },
      { property: "og:title", content: "IOMBiz — Premium Online Supermarket" },
      { property: "og:description", content: "The professional choice for your household essentials. Built for reliability." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@IOMBiz" },
    ],
    links: [
